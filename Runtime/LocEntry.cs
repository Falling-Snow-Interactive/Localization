...
namespace Fsi.Localization
{
	...
	public class LocEntry
	{
		...
		[SerializeField]
		private string fallback = "no_loc";
		...
		public LocEntry(string table, string key)
		{
			entry = new LocalizedString
			        {
				        TableReference = table,
				        TableEntryReference = key, //$"{id}_name",
			        };;

			fallback = key;
		}

		public string GetLocalizedString(Dictionary<string, string> args)
		{
			if (entry.IsEmpty)
			{
